...
declare -A gerrit_ko=(["port"]=29418 ["http"]=8080 ["name"]="gerrit-3.1.2" ["file"]="${BASEDIR}/Downloads/gerrit-3.1.2.war" ["usernum"]=1 ["gitremote"]="remoteko")
declare -A gerrit_ok=(["port"]=29419 ["http"]=8081 ["name"]="gerrit-patch" ["file"]="${BASEDIR}/gerrit.git/bazel-bin/gerrit.war" ["usernum"]=2 ["gitremote"]="remoteok")
