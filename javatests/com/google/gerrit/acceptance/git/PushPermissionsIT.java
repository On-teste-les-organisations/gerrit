...
public class PushPermissionsIT extends AbstractDaemonTest {
  ...
  public void pushMergeRegular() throws Exception {
    ...
    RevCommit c1 = testRepo.commit().message("COMMIT 1").create();
    RevCommit c2 = testRepo.commit().parent(c1).message("COMMIT 2").create();
    RevCommit c3 = testRepo.commit().parent(c1).parent(c2).message("COMMIT 3").create();
